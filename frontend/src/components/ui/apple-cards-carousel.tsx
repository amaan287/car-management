  ...
  return (
    <>
        ...
        {open && (
          <div className="fixed inset-0 h-screen z-50 overflow-auto">
            ...
            <motion.div
              ...
              className="max-w-5xl mx-auto bg-white dark:bg-neutral-900 h-fit object-contain  z-[60] my-10 p-4 md:p-10 rounded-3xl font-sans relative"
            >
              <button
      ...
      <motion.button
        layoutId={layout ? `card-${card.title}` : undefined}
        onClick={handleOpen}
        className="rounded-3xl bg-gray-100 dark:bg-neutral-900 w-56 md:w-96 overflow-hidden flex flex-col items-start  justify-start relative z-10 aspect-[10/12] "
      >
